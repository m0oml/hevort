; ======================================================================================
; Home All Axes - Sequential XY then Z
...
; --- 2. Home XY (dual-pass coarse/fine) ---
var xTravel = move.axes[0].max - move.axes[0].min + 5
var yTravel = move.axes[1].max - move.axes[1].min + 5
G91                                              ; Relative positioning
G1 H1 X{-var.xTravel} Y{-var.yTravel} F600       ; Coarse home XY together
G1 H1 X{-var.xTravel} F600                       ; Coarse home X alone
G1 H1 Y{-var.yTravel} F600                       ; Coarse home Y alone
G1 X5 Y5 F6000                                  ; Back off 5mm
G1 H1 X{-var.xTravel} Y{-var.yTravel} F300       ; Fine home XY together
G1 H1 X{-var.xTravel} F300                       ; Fine home X alone
G1 H1 Y{-var.yTravel} F300                       ; Fine home Y alone
G90                                              ; Absolute positioning

; --- 3. Home Z (probe at bed centre) ---
