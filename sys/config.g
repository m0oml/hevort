...
M208 X0:415 Y0:415 Z0:440                               ; Axis limits
...
M569.2 P0.0 S1 A1 C"out3"                              ; Z0 brake on out3, active high = release
M569.2 P0.1 S1 A1 C"out3"                              ; Z1 brake on out3 (commoned)
M569.2 P0.2 S1 A1 C"out3"                              ; Z2 brake on out3 (commoned)
...
M308 S1 P"temp1" Y"thermistor" A"Bed" T100000 B3950     ; Bed interior thermistor 100K B3950 - PID source
M308 S2 P"temp2" Y"thermistor" A"BedMat" T100000 B3950  ; Bed heater mat surface 100K B3950 - safety limit only
M308 S3 P"temp3" Y"thermistor" A"Coolant" T100000 B3950 ; Coolant NTC 10K B3950 (Alphacool Eiszapfen)
M308 S10 P"mcu-temp" Y"mcu-temp" A"MCU Temp"            ; MCU temperature sensor
...
M143 H1 P0 T0 C0 S350 A0                                ; Hotend safety limit 350C
...
M106 P0 S0 L0 X1 H10:11 T40:60:100:100 B0.1            ; Off below 40C, full at 60C, full if drivers warn
...
; Pause button on IO8 (NO - make to pause)
M950 J2 C"io8.in"                                       ; Input 2: pause button
M581 T2 P2 S1 R1                                        ; Trigger 2 on pause button make, during print only

; Stop button on IO9 (NC - break to stop)
M950 J3 C"io9.in"                                       ; Input 3: stop button
...
; ===================== Finalization ===================
M98 P"vars.g"                                           ; Load chamber variables
